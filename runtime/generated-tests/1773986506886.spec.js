...
test.describe('Practice login test', () => {
    ...
    test('Positive: Login using valid credentials', async ({ page }) => {
        try {
            ...
            await page.screenshot({
                path: 'runtime/artifacts/1773986506886/positive-success.png'
            });

        } catch (error) {
            await page.screenshot({
                path: 'runtime/artifacts/1773986506886/positive-failure.png'
            });
            throw error;
        }
    });
    ...
    test('Negative: Login with invalid password', async ({ page }) => {
        try {
            ...
            await page.screenshot({
                path: 'runtime/artifacts/1773986506886/invalid-password.png'
            });

        } catch (error) {
            await page.screenshot({
                path: 'runtime/artifacts/1773986506886/invalid-password-failure.png'
            });
            throw error;
        }
    });
    ...
    test('Negative: Login with invalid username', async ({ page }) => {
        try {
            ...
            await page.screenshot({
                path: 'runtime/artifacts/1773986506886/invalid-username.png'
            });

        } catch (error) {
            await page.screenshot({
                path: 'runtime/artifacts/1773986506886/invalid-username-failure.png'
            });
            throw error;
        }
    });
